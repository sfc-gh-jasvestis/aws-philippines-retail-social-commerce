...
export default function HomePage() {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 grid-cols-1">
        <Chart
          ...
          title="Social Commerce Revenue (Weekly)"
        />
        <Chart
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        <Chart
          ...
          type="pie"
          xKey="label"
          yKeys={[{ key: 'value', name: 'ROAS' }]}
          title="ROI by Influencer Tier"
        />
        <ActionMemo
          persona={{ name: 'Bianca Torres', role: 'VP Social Commerce' }}
          context={{}}
          onGenerate={async () => {
            const memos = [
              {
                ...
                actions: ['Book top beauty influencers for 12.12 live marathon', 'Launch TikTok Shop integration for fashion category', 'Analyze content virality factors for organic reach'],
              },
              {
  ...
  const askAiTab = (
    <div className="h-[600px]">
      <AskAI
        title="Ask AI"
        sampleQuestions={[
          'Which influencers drive the highest GMV per stream?',
          'Show live stream conversion rate by time slot',
          'What content format generates the most engagement?',
        ]}
        mode="sql"
  ...
  const tabs = [
    ...
    { id: 'domain-1', label: 'Live Commerce', icon: '📈', content: domainTab1 },
    { id: 'domain-2', label: 'Creator Economics', icon: '⚡', content: domainTab2 },
